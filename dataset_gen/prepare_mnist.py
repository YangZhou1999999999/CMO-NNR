...
def parse_args():
    ...
    parser.add_argument('-D', '--dataset', type=str, default='cmnist', choices=['mnist', 'cmnist', 'cifar10'])
...
def process_image(params):
    ...
    n_sp_query = args.n_sp + (20 if args.dataset in ['mnist'] else 50)  # number of superpixels we ask to extract (larger to extract more superpixels - closer to the desired n_sp)
